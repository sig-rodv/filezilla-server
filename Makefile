...
CONFIG_CLEAN_FILES = pkg/mac/scripts/service/postinstall
...
DIST_SUBDIRS = res src pkg demos tests
am__DIST_COMMON = $(srcdir)/Makefile.in $(top_srcdir)/config/ar-lib \
	$(top_srcdir)/config/compile $(top_srcdir)/config/config.guess \
	$(top_srcdir)/config/config.sub \
	$(top_srcdir)/config/install-sh $(top_srcdir)/config/ltmain.sh \
	$(top_srcdir)/config/missing \
	$(top_srcdir)/pkg/mac/scripts/service/postinstall.in COPYING \
	NEWS config/ar-lib config/compile config/config.guess \
...
WX_VERSION_MICRO = 2
WX_VERSION_MINOR = 2
abs_builddir = /home/kali/demo/filezilla-server-1.7.3
abs_srcdir = /home/kali/demo/filezilla-server-1.7.3
...
$(am__aclocal_m4_deps):
pkg/mac/scripts/service/postinstall: $(top_builddir)/config.status $(top_srcdir)/pkg/mac/scripts/service/postinstall.in
