...
/* The canonicalized host type */
#define FZ_BUILD_HOST "x86_64-pc-linux-gnu"
...
#define PACKAGE_VERSION_SHORT "1.7.3"
...
/* Define if you want to disable the update checker */
/* #undef WITHOUT_FZ_UPDATE_CHECKER */
